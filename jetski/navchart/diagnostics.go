...
//
// If one chart has more actions than the other, the surplus actions
// are reported as mismatches with empty Actual or Expected.
...
// actionSummary produces a human-readable one-line summary of a ChartAction
